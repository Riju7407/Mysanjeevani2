...
export default function TermsPage() {
  return (
    <InfoPageLayout
      ...
      subtitle="These Terms and Conditions constitute a binding agreement governing access to and use of MySanjeevni websites, applications, and related services."
      ...
      sections={[
        ...
        },
        {
          ...
          content: [
            ...
            'To the maximum extent permitted by applicable law, MySanjeevni disclaims liability for indirect, incidental, special, or consequential losses arising from platform use or service interruption.',
          ],
        },
        {
          heading: 'Indemnity',
          content: [
            'You agree to defend, indemnify, and hold harmless MySanjeevni, its affiliates, directors, employees, and service providers from and against any claims, losses, penalties, liabilities, and costs (including reasonable legal fees) arising out of your breach of these Terms, misuse of the platform, or violation of applicable law or third-party rights.',
        ...
        },
        {
          ...
          content: [
            'To the maximum extent permitted by law, the aggregate liability of MySanjeevni for any and all claims arising from or relating to the platform or services shall not exceed the total amount actually paid by you for the specific transaction giving rise to the claim or INR 5,000, whichever is lower.',
        ...
        },
        {
          ...
          content: [
            'MySanjeevni shall not be liable for delay or failure in performance caused by events beyond reasonable control, including natural disasters, public health emergencies, government actions, network failures, labor disruptions, or logistics interruptions.',
