        ...
        <div className="max-w-7xl mx-auto px-4 py-1">
          <div className="flex flex-col gap-4 md:gap-0 md:flex-row md:items-center md:justify-between">
            ...
            <select
              ...
              className="w-full md:w-auto border-2 border-pink-200 rounded-xl px-4 py-3 bg-white focus:outline-none focus:ring-2 focus:ring-pink-400 transition text-sm font-medium text-gray-700"
            >
